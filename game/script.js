...
class MonopolyGame {
    constructor() {
        ...
        // GitHub API 相关 - 预设配置
        this.githubRepo = '2dog-Z/2dog-Z.github.io'; // 请替换为你的仓库
        this.githubToken = 'githu'+
        'b_pat_11BNK7WAQ0fJUJBx'+
        'BxGGxX_C4f1OY7kUqr8E9z'+
        'ZNd6DqjLiqayGsgCKzxUQ'+
        'sboBhltPCBXZJB46g4d7wxv'; // 请替换为实际的GitHub Token
    ...
    async connectToGitHub() {
        ...
        try {
            ...
            this.addLog('连接失败，请检查代码中的仓库配置和API密钥');
